var GEO_TYPES = ['cone', 'cylinder', 'octahedron', 'sphere', 'tetrahedron', 'torus', 'torusKnot'];
...
function init() {
  ...
  var objMaterial = getMaterial('basic', 'rgb(240,240,240)');
  var obj = getGeometry('torus', 1, objMaterial);
  console.log(obj);
  ...
  var folder4 = gui.addFolder('primitives');
  folder4.add(obj, 'name');
